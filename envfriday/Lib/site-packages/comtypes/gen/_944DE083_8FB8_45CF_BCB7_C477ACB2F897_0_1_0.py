...
__all__ = [
    'UIA_AriaRolePropertyId', 'UIA_GridRowCountPropertyId',
    'ZoomUnit_NoAmount', 'CoalesceEventsOptions_Enabled',
    'UIA_GridItemRowSpanPropertyId',
    'NotificationKind_ActionCompleted', 'IUIAutomation6',
    'WindowInteractionState_Running', 'UIA_AriaPropertiesPropertyId',
    'UIA_BulletStyleAttributeId', 'UIA_MenuClosedEventId',
    'UIA_RangeValueValuePropertyId', 'IUIAutomationGridItemPattern',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_DropTargetPatternId', 'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_IsValuePatternAvailablePropertyId', 'AnnotationType_Author',
    'TextUnit_Format', 'UIA_SemanticZoomControlTypeId',
    'UIA_Text_TextSelectionChangedEventId', 'NotificationKind',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_IsItalicAttributeId', 'ProviderOptions_ClientSideProvider',
    'UIA_TabsAttributeId', 'TextPatternRangeEndpoint',
    'UIA_StylesShapePropertyId', 'UIA_StrikethroughColorAttributeId',
    'UIA_TableColumnHeadersPropertyId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'TextEditChangeType_Composition', 'UIA_DragDropEffectsPropertyId',
    'UIA_HeaderItemControlTypeId', 'UIA_FontNameAttributeId',
    'UIA_LevelPropertyId', 'ProviderOptions_RefuseNonClientSupport',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_LandmarkTypePropertyId', 'AnnotationType_UnsyncedChange',
    'AnnotationType_ExternalChange', 'UIA_CulturePropertyId',
    'UIA_AnnotationObjectsAttributeId', 'UIA_VisualEffectsPropertyId',
    'AnnotationType_DeletionChange', 'UIA_FlowsFromPropertyId',
    'UIA_SizeOfSetPropertyId', 'TextEditChangeType_AutoComplete',
    'UIA_ButtonControlTypeId', 'UIA_TextEdit_TextChangedEventId',
    'TextUnit_Line', 'AnnotationType_CircularReferenceError',
    ...
    'UIA_CapStyleAttributeId', 'TextUnit_Page',
    'RowOrColumnMajor_Indeterminate', 'UIA_CustomNavigationPatternId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'AnnotationType_Highlighted',
    'UIA_StylesExtendedPropertiesPropertyId', 'DockPosition_Top',
    'NotificationKind_Other', 'UIA_StyleIdAttributeId',
    'UIA_Drag_DragCancelEventId', 'StyleId_Custom', 'LiveSetting',
    'UIA_PositionInSetPropertyId', 'ZoomUnit_LargeIncrement',
    'UIA_EditControlTypeId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'NavigateDirection_FirstChild', 'UIA_ObjectModelPatternId',
    'UIA_IndentationFirstLineAttributeId', 'ZoomUnit',
    'StructureChangeType_ChildAdded', 'DockPosition_Fill',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_SeparatorControlTypeId', 'UIA_TextChildPatternId',
    'IUIAutomationTextPattern2', 'UIA_GridItemPatternId',
    'IUIAutomationSpreadsheetPattern', 'DockPosition_Right',
    'UIA_StylesPatternId', 'StyleId_Heading3',
    ...
    'UIA_ClassNamePropertyId', 'UIA_ProviderDescriptionPropertyId',
    'IUIAutomationItemContainerPattern',
    'IUIAutomationProxyFactoryMapping', 'IUIAutomationAndCondition',
    ...
    'StyleId_Heading4', 'UIA_OutlineStylesAttributeId',
    'TextEditChangeType_None', 'AnnotationType_GrammarError',
    'UIA_WindowIsModalPropertyId', 'UIA_ToolTipControlTypeId',
    'UIA_AnnotationPatternId', 'UIA_Window_WindowClosedEventId',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_SpreadsheetItemPatternId', 'UIA_SystemAlertEventId',
    'StyleId_Heading5', 'UIA_InputDiscardedEventId',
    ...
    'UIA_TitleBarControlTypeId', 'WindowInteractionState_Closing',
    'UIA_ItemStatusPropertyId', 'UIA_WindowIsTopmostPropertyId',
    'UIA_TextEditPatternId', 'HeadingLevel8',
    ...
    'IUIAutomationElement4', 'UIA_Transform2CanZoomPropertyId',
    'UIA_CaretBidiModeAttributeId', 'UIA_StructureChangedEventId',
    'UIA_ThumbControlTypeId', 'TextEditChangeType',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId', 'HeadingLevel7',
    'UIA_ControllerForPropertyId', 'UiaChangeInfo',
    ...
    'ScrollAmount_LargeDecrement', 'NavigateDirection_Parent',
    'AnnotationType_TrackChanges', 'UIA_SummaryChangeId',
    'OrientationType_None', 'TextUnit_Word', 'ScrollAmount_NoAmount',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_WindowCanMaximizePropertyId', 'IUIAutomationElement',
    'TextUnit_Character', 'IUIAutomationElement2',
    'UIA_SelectionItemPatternId', 'UIA_FlowsToPropertyId',
    ...
    'IUIAutomationGridPattern', 'UIA_SayAsInterpretAsMetadataId',
    'UIA_Transform2ZoomMaximumPropertyId', 'UIA_ImageControlTypeId',
    'UIA_MenuBarControlTypeId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_StylesFillPatternColorPropertyId', 'TreeScope_Children',
    'UIA_IsDataValidForFormPropertyId',
    'NotificationProcessing_MostRecent', 'AutomationElementMode_Full',
    'IUIAutomationChangesEventHandler', 'AnnotationType_Header',
    'StyleId_BulletedList', 'StyleId_Heading8',
    'UIA_SelectionSelectionPropertyId', 'IUIAutomationElement3',
    'TreeScope_Ancestors', 'UIA_SelectionItem_ElementSelectedEventId',
    'AutomationElementMode', 'AnnotationType_EditingLockedChange',
    'UIA_ValueValuePropertyId', 'UIA_LocalizedLandmarkTypePropertyId',
    'TextEditChangeType_AutoCorrect',
    'AnnotationType_AdvancedProofingIssue', 'StyleId_NumberedList',
    'AnnotationType_ConflictingChange',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'ProviderOptions_UseClientCoordinates', 'HeadingLevel4',
    'UIA_TabControlTypeId', 'UIA_DropTarget_DroppedEventId',
    'ScrollAmount_LargeIncrement', 'TreeScope_None',
    'NotificationKind_ItemRemoved', 'UIA_HasKeyboardFocusPropertyId',
    'UIA_DockDockPositionPropertyId',
    'IUIAutomationSelectionItemPattern',
    'UIA_Text_TextChangedEventId', 'UIA_FullDescriptionPropertyId',
    'IUIAutomationDockPattern', 'OrientationType_Horizontal',
    'NavigateDirection_NextSibling', 'IUIAutomationProxyFactory',
    'UIA_TableRowHeadersPropertyId', 'UIA_ForegroundColorAttributeId',
    'PropertyConditionFlags_None', 'UIA_TransformCanRotatePropertyId',
    'IUIAutomationPropertyCondition',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_FillColorPropertyId', 'UIA_MenuModeStartEventId',
    'IUIAutomation4', 'OrientationType',
    'UIA_ProgressBarControlTypeId', 'StyleId_Quote',
    'AnnotationType_Footer',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'IUIAutomationMultipleViewPattern', 'HeadingLevel9',
    'AnnotationType_MoveChange', 'UIA_SynchronizedInputPatternId',
    'UIA_TablePatternId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_BackgroundColorAttributeId', 'UIA_SliderControlTypeId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_ProcessIdPropertyId', 'IUIAutomationDragPattern',
    'UIA_ChangesEventId', 'IUIAutomationElement6',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_FontWeightAttributeId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_LegacyIAccessiblePatternId', 'UIA_TableItemPatternId',
    'UIA_IsTextPatternAvailablePropertyId', 'StyleId_Title',
    'AnnotationType_Sensitive', 'UIA_AnnotationAuthorPropertyId',
    'UIA_TextPattern2Id', 'UIA_DataItemControlTypeId',
    'UIA_FillTypePropertyId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'WindowInteractionState', 'UIA_WindowCanMinimizePropertyId',
    'IUIAutomationScrollPattern', 'UIA_SpinnerControlTypeId',
    'IUIAutomationScrollItemPattern', 'UIA_RadioButtonControlTypeId',
    'IUIAutomation3', 'UIA_ListControlTypeId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_AppBarControlTypeId', 'UIA_SayAsInterpretAsAttributeId',
    'HeadingLevel5', 'UIA_Window_WindowOpenedEventId',
    'NotificationProcessing_ImportantMostRecent',
    'IUIAutomationElement5', 'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId', 'StyleId_Normal',
    'UIA_MarginBottomAttributeId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'NotificationProcessing_CurrentThenMostRecent',
    'IUIAutomationInvokePattern', 'UIA_LinkAttributeId',
    'UIA_ExpandCollapsePatternId', 'IUIAutomationProxyFactoryEntry',
    'StyleId_Heading1', 'UIA_TextFlowDirectionsAttributeId',
    'UIA_OrientationPropertyId',
    'UIA_IsTransformPatternAvailablePropertyId', 'ToggleState_Off',
    'UIA_DragIsGrabbedPropertyId', 'IUIAutomationTextRange3',
    'RowOrColumnMajor_RowMajor',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_ScrollVerticallyScrollablePropertyId', 'DockPosition',
    'UIA_IsCustomNavigationPatternAvailablePropertyId', 'TreeScope',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_TabItemControlTypeId', 'IUIAutomationCacheRequest',
    'UIA_LineSpacingAttributeId', 'TreeTraversalOptions_Default',
    'IAccessible', 'UIA_IsControlElementPropertyId',
    'UIA_ControlTypePropertyId',
    'UIA_RangeValueLargeChangePropertyId', 'UIA_WindowControlTypeId',
    'AutomationElementMode_None', 'SynchronizedInputType_KeyDown',
    'IUIAutomationTextRange2', 'TreeScope_Element',
    'IUIAutomationSynchronizedInputPattern', 'UIA_ValuePatternId',
    ...
    'AnnotationType_Endnote', 'UIA_AnimationStyleAttributeId',
    'UIA_LayoutInvalidatedEventId',
    'UIA_IsGridPatternAvailablePropertyId',
    'IUIAutomationTransformPattern2', 'UIA_HyperlinkControlTypeId',
    'IUIAutomationOrCondition', 'ProviderOptions_UseComThreading',
    'UIA_GridItemContainingGridPropertyId',
    'UIA_CaretPositionAttributeId', 'UIA_MarginTrailingAttributeId',
    'TreeScope_Parent', 'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_HeaderControlTypeId', 'UIA_SelectionPatternId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'PropertyConditionFlags', 'HeadingLevel1',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_FrameworkIdPropertyId', 'ZoomUnit_SmallIncrement',
    'UIA_BeforeParagraphSpacingAttributeId',
    'ToggleState_Indeterminate', 'IUIAutomationBoolCondition',
    'IUIAutomationEventHandlerGroup', 'ZoomUnit_SmallDecrement',
    'SupportedTextSelection',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_TreeControlTypeId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'WindowVisualState_Normal', 'TextPatternRangeEndpoint_Start',
    'UIA_IsPeripheralPropertyId', 'UIA_MarginLeadingAttributeId',
    'UIA_GridItemColumnPropertyId',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_IndentationLeadingAttributeId', 'UIA_IsPasswordPropertyId',
    'UIA_IsHiddenAttributeId', 'UIA_ToggleToggleStatePropertyId',
    'UIA_GroupControlTypeId', 'NotificationKind_ItemAdded',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_Selection_InvalidatedEventId', 'ScrollAmount_SmallDecrement',
    'IUIAutomation2', 'AnnotationType_Comment',
    'UIA_LocalizedControlTypePropertyId', 'UIA_NotificationEventId',
    'UIA_StylesFillColorPropertyId', 'WindowVisualState',
    'NotificationProcessing_All',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_ToolTipOpenedEventId', 'AnnotationType_Unknown',
    'IUIAutomationTransformPattern', 'UIA_ToolBarControlTypeId',
    'NotificationKind_ActionAborted', 'UIA_DataGridControlTypeId',
    'IUIAutomationTogglePattern', 'TreeScope_Descendants',
    'UIA_Drag_DragCompleteEventId', 'UIA_TransformCanMovePropertyId',
    'UIA_RotationPropertyId', 'UIA_IsKeyboardFocusablePropertyId',
    'TreeScope_Subtree', 'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_InputReachedOtherElementEventId',
    'UIA_StatusBarControlTypeId', 'ZoomUnit_LargeDecrement',
    'DockPosition_None', 'UIA_IsRangeValuePatternAvailablePropertyId',
    ...
    'UIA_AsyncContentLoadedEventId', 'UIA_HeadingLevelPropertyId',
    'TreeTraversalOptions', 'UIA_NativeWindowHandlePropertyId',
    'UIA_SplitButtonControlTypeId', 'IUIAutomationSelectionPattern',
    'TextUnit', 'CUIAutomation8', 'SynchronizedInputType_LeftMouseUp',
    'IUIAutomationSpreadsheetItemPattern',
    'AnnotationType_InsertionChange', 'UIA_LiveRegionChangedEventId',
    'ConnectionRecoveryBehaviorOptions',
    'UIA_InputReachedTargetEventId', 'UIA_UnderlineStyleAttributeId',
    'NavigateDirection_PreviousSibling', 'IUIAutomationElement9',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'SupportedTextSelection_Multiple', 'UIA_TransformPatternId',
    'IUIAutomationTextRange', 'IUIAutomationCondition',
    'UIA_RangeValuePatternId', 'UIA_IsActiveAttributeId',
    'UIA_DescribedByPropertyId', 'UIA_ListItemControlTypeId',
    'StyleId_Heading9', 'CoalesceEventsOptions', 'HeadingLevel3',
    'UIA_LegacyIAccessibleRolePropertyId', 'HeadingLevel2',
    'UIA_TableRowOrColumnMajorPropertyId', 'UIA_IsEnabledPropertyId',
    'UIA_InvokePatternId', 'UIA_TableItemRowHeaderItemsPropertyId',
    'IUIAutomationStructureChangedEventHandler',
    'IUIAutomationTextChildPattern', 'UIA_HelpTextPropertyId',
    'TextUnit_Paragraph', 'UIA_CustomLandmarkTypeId',
    'IUIAutomationTextEditPattern', 'IUIAutomationElement8',
    'IUIAutomationTextPattern',
    'UIA_StylesFillPatternStylePropertyId', 'UIA_TransformPattern2Id',
    'ProviderOptions_ServerSideProvider', 'UIA_SelectionPattern2Id',
    'RowOrColumnMajor', 'IUIAutomationStylesPattern',
    'UIA_StyleNameAttributeId',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_CustomControlTypeId', 'CUIAutomation',
    'TextEditChangeType_CompositionFinalized',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'AnnotationType_Mathematics', 'ScrollAmount',
    'UIA_SizePropertyId', 'NavigateDirection_LastChild',
    'UIA_MenuOpenedEventId', 'ProviderOptions_ProviderOwnsSetFocus',
    ...
    'AnnotationType_DataValidationError', 'UIA_IsOffscreenPropertyId',
    'DockPosition_Left', 'ExpandCollapseState_LeafNode',
    'UIA_OverlineStyleAttributeId', 'UIA_Invoke_InvokedEventId',
    ...
    'UIA_SearchLandmarkTypeId', 'PropertyConditionFlags_IgnoreCase',
    'IUIAutomationTableItemPattern',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_CultureAttributeId', 'UIA_IsDialogPropertyId',
    'StructureChangeType_ChildRemoved', 'UIA_StylesStyleIdPropertyId',
    'UIA_UnderlineColorAttributeId', 'UIA_CheckBoxControlTypeId',
    'NotificationProcessing_ImportantAll',
    'SupportedTextSelection_None',
    'StructureChangeType_ChildrenBulkAdded',
    'StructureChangeType_ChildrenReordered', 'UIA_MenuModeEndEventId',
    'HeadingLevel6', 'StyleId_Heading6',
    'UIA_TransformCanResizePropertyId', 'UIA_MenuItemControlTypeId',
    'IUIAutomation5', 'UIA_AccessKeyPropertyId',
    'AnnotationType_FormatChange', 'StyleId_Emphasis',
    'UIA_GridPatternId', 'UIA_HorizontalTextAlignmentAttributeId',
    ...
    'UIA_TreeItemControlTypeId', 'IUIAutomationExpandCollapsePattern',
    'Assertive', 'AnnotationType_FormulaError', 'DockPosition_Bottom',
    'UIA_TogglePatternId', 'UIA_ScrollPatternId',
    ...
    'IUIAutomationRangeValuePattern', 'UIA_GridColumnCountPropertyId',
    'UIA_BoundingRectanglePropertyId',
    'WindowInteractionState_NotResponding',
    'SynchronizedInputType_RightMouseDown',
    'UIA_AutomationFocusChangedEventId', 'ExpandCollapseState',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'IRawElementProviderSimple', 'UIA_FormLandmarkTypeId',
    'IUIAutomationCustomNavigationPattern',
    'UIA_DragDropEffectPropertyId',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_OverlineColorAttributeId',
    'UIA_AutomationPropertyChangedEventId',
    'IUIAutomationNotCondition', 'UIA_AnnotationDateTimePropertyId',
    'StyleId_Subtitle', 'UIA_StylesStyleNamePropertyId',
    'UIA_AnnotationTypesAttributeId', 'IUIAutomationValuePattern',
    ...
    'Polite', 'UIA_IsTablePatternAvailablePropertyId',
    'ScrollAmount_SmallIncrement', 'UIA_CenterPointPropertyId',
    'ExpandCollapseState_Expanded', 'UIA_Drag_DragStartEventId',
    'UIA_ItemTypePropertyId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'IUIAutomationDropTargetPattern', 'HeadingLevel_None',
    'IUIAutomationObjectModelPattern', 'ProviderOptions',
    'UIA_SelectionActiveEndAttributeId',
    'UIA_Transform2ZoomLevelPropertyId', 'UIA_MainLandmarkTypeId',
    'WindowVisualState_Maximized', 'SupportedTextSelection_Single',
    'UIA_ValueIsReadOnlyPropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_PaneControlTypeId', 'UIA_RangeValueMinimumPropertyId',
    'AnnotationType_SpellingError', 'TextUnit_Document',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_Transform2ZoomMinimumPropertyId',
    'WindowVisualState_Minimized', 'CoalesceEventsOptions_Disabled',
    'UIA_TextPatternId', 'UIA_IsContentElementPropertyId',
    'SynchronizedInputType_RightMouseUp', 'UIA_ScrollItemPatternId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'ExtendedProperty', 'UIA_NamePropertyId',
    'UIA_DropTarget_DragEnterEventId', 'UIA_IsSubscriptAttributeId',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_VirtualizedItemPatternId', 'Off', 'StyleId_Heading7',
    'UIA_GridItemRowPropertyId'
]

_check_version('1.2.0', 1701792578.171445)
