...
__all__ = [
    'ISpShortcut', 'DISPID_SpeechPhraseElements', 'SVP_6',
    'SRTEmulated', 'DISPID_SpeechVoiceEvent', 'SpResourceManager',
    'SpTextSelectionInformation', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SPIAudioStreamPosition', 'SPGS_ENABLED',
    'SpeechDictationTopicSpelling', 'SAFT44kHz16BitStereo',
    'SpeechVoiceEvents', 'SGDSActiveUserDelimited',
    'DISPID_SRCERecognitionForOtherContext',
    'SDA_Consume_Leading_Spaces', 'SAFTDefault', 'SDTAudio',
    'SP_VISEME_13', 'DISPID_SVSPhonemeId', 'SpeechTokenValueCLSID',
    ...
    'SECLowConfidence', 'DISPID_SRRAlternates', 'ISpNotifyTranslator',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFT44kHz16BitMono',
    ...
    'DISPID_SRCResume', 'DISPID_SMSALineId', 'SpNullPhoneConverter',
    'SpeechRecoEvents', 'DISPID_SVWaitUntilDone', 'SPAR_Medium',
    'DISPID_SRGetPropertyString', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SLWs_NewEnum', 'SVSFParseAutodetect', 'DISPID_SVStatus',
    'DISPID_SpeechVoiceStatus', 'SPEI_RECO_OTHER_CONTEXT',
    'eLEXTYPE_PRIVATE20', 'SPPS_LMA', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SWPUnknownWordUnpronounceable', 'SPWAVEFORMATTYPE',
    'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE1',
    'SpeechRecoProfileProperties', 'SpMMAudioOut',
    'DISPID_SOTs_NewEnum', 'DISPID_SPEPronunciation', 'SPAUDIOSTATUS',
    'DISPID_SpeechRecognizerStatus', 'SRAInterpreter',
    'SPCONTEXTSTATE', 'DISPID_SGRsItem', 'SAFT32kHz16BitMono',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRId',
    'SVEAudioLevel', 'DISPID_SpeechMemoryStream', 'SVP_9',
    'SVSFParseMask', 'SVF_Stressed', 'ISpeechWaveFormatEx',
    'SWTDeleted', 'DISPID_SRSClsidEngine', 'SDTDisplayText',
    'SPCT_SUB_COMMAND', 'DISPID_SGRSTs_NewEnum', 'SGDSActive',
    'SPLEXICONTYPE', 'SDTReplacement', 'SECNormalConfidence',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRCState',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPEDisplayText',
    'DISPID_SpeechDataKey', 'DISPID_SRGReset', 'SPBO_PAUSE',
    'DISPID_SGRSTType', 'DISPID_SASNonBlockingIO',
    'ISpeechLexiconPronunciations', 'ISpRecoContext',
    'SDA_One_Trailing_Space', 'SPRST_INACTIVE',
    'DISPID_SWFEFormatTag', 'SPPS_NotOverriden',
    'SREPropertyStringChange', 'SAFTGSM610_22kHzMono',
    'SAFTExtendedAudioFormat', 'DISPID_SRIsShared',
    'DISPID_SpeechFileStream', 'SPDKL_CurrentConfig', 'SP_VISEME_17',
    'DISPID_SGRSAddRuleTransition', 'SP_VISEME_4', 'SPPS_Noncontent',
    'DISPID_SGRInitialState', 'DISPID_SPILanguageId',
    'DISPID_SASetState', 'SRARoot', 'DISPID_SLWType',
    'DISPID_SPEActualConfidence', 'DISPID_SDKSetLongValue',
    'SAFTADPCM_11kHzMono', 'SPEI_MIN_SR', 'SAFT16kHz8BitMono',
    'SAFT32kHz8BitStereo', 'SAFT48kHz16BitStereo',
    'DISPID_SPIStartTime', 'SpeechGrammarTagUnlimitedDictation',
    'SAFT11kHz8BitStereo', 'SAFT12kHz8BitStereo', 'SpWaveFormatEx',
    'ISpRecognizer2', 'SRTExtendableParse', 'SVEPhoneme',
    'DISPID_SOTsItem', 'SVSFDefault', 'SP_VISEME_12',
    'ISpeechPhraseProperty', 'ISpeechRecognizer',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPPsCount',
    'SpAudioFormat', 'SP_VISEME_21', 'SECHighConfidence',
    'DISPID_SPRuleConfidence', 'DISPID_SRCVoice', 'DISPID_SRGRules',
    'ISpeechGrammarRuleStateTransition', 'ISpProperties',
    'DISPID_SGRName', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVSRunningState', 'DISPID_SLWsCount',
    'DISPID_SpeechCustomStream', 'ISpRecognizer', 'SPEI_RESERVED2',
    'SBONone', 'ISpeechResourceLoader', 'SPRECORESULTTIMES',
    'DISPID_SPPEngineConfidence', 'SVP_20', 'SAFT22kHz8BitMono',
    'SPWORDPRONUNCIATION', 'DISPID_SRGetPropertyNumber',
    'SpeechVoiceSkipTypeSentence', 'SPLO_STATIC', 'DISPID_SPIRule',
    'ISpeechPhraseRule', 'SPXRO_SML', 'DISPID_SAFGuid',
    'SRESoundStart', 'SVEEndInputStream', 'DISPID_SpeechRecoResult',
    ...
    'DISPID_SpeechAudio', 'SpeechTokenShellFolder',
    'DISPID_SpeechPhraseInfo', 'SPPHRASEREPLACEMENT',
    'SAFTCCITT_uLaw_11kHzMono', 'SPEI_SR_RETAINEDAUDIO',
    'SPEI_HYPOTHESIS', 'SPVPRI_OVER', 'SBOPause', 'DISPID_SLGetWords',
    'SP_VISEME_11', 'SPBO_AHEAD', 'SAFT11kHz8BitMono',
    'SAFT8kHz8BitMono', 'DISPID_SRRTimes', 'SGSEnabled',
    'ISpMMSysAudio', 'DISPID_SWFEChannels', 'STSF_LocalAppData',
    'DISPID_SVAudioOutputStream', 'STCInprocHandler',
    'SpeechAudioState', 'ISpResourceManager',
    'DISPID_SRCCreateGrammar', 'SpeechGrammarState',
    'eLEXTYPE_PRIVATE17', 'DISPID_SGRSTsCount',
    ...
    'ISpeechObjectTokens', 'SPAUDIOSTATE', 'DISPID_SRSAudioStatus',
    ...
    'SAFT11kHz16BitMono', 'SPWF_SRENGINE', 'ISpeechLexicon',
    'SPLO_DYNAMIC', 'SP_VISEME_1', 'eLEXTYPE_PRIVATE4',
    'SPSHORTCUTPAIR', 'DISPID_SPPs_NewEnum', 'SRTSMLTimeout',
    'ISpeechObjectToken', 'DISPID_SPELexicalForm',
    ...
    'SPEI_PHONEME', 'SPBOOKMARKOPTIONS', 'SpeechCategoryAppLexicons',
    'SPSNotOverriden', 'DISPID_SOTCDefault',
    'DISPID_SABIMinNotification', 'DISPID_SRGState',
    'SECFEmulateResult', 'SpeechTokenKeyFiles', 'SAFT12kHz16BitMono',
    'SAFT44kHz8BitStereo', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechObjectToken', 'DISPID_SADefaultFormat',
    'SP_VISEME_5', 'ISpeechBaseStream', 'SPCT_DICTATION',
    'DISPID_SLPLangId', 'DISPID_SpeechRecoResultTimes',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPEI_REQUEST_UI',
    'ISpeechPhraseReplacement', 'SP_VISEME_8', 'DISPID_SGRClear',
    'ISpVoice', '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_16',
    'SPEI_START_SR_STREAM', 'tagSPTEXTSELECTIONINFO',
    'Speech_Max_Word_Length', 'SVP_4', 'DISPID_SASState',
    'DISPID_SPIEngineId', 'DISPID_SVSkip', 'SPPHRASE',
    'DISPID_SABufferNotifySize', 'SPAO_RETAIN_AUDIO', 'SRTReSent',
    'DISPID_SLPsCount', 'ISpNotifySource',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechPhraseRule', 'SGPronounciation', 'SGRSTTDictation',
    'DISPID_SPRDisplayAttributes', 'SpeechGrammarTagWildcard',
    'SVP_1', 'DISPID_SLWsItem', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'IInternetSecurityMgrSite', 'DISPID_SOTsCount',
    'DISPID_SRCEStartStream', 'SPEI_FALSE_RECOGNITION',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPIAudioSizeTime',
    'SPSHORTCUTPAIRLIST', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPRulesCount', 'DISPID_SRDisplayUI',
    'DISPID_SVEVoiceChange', 'DISPID_SRSSupportedLanguages',
    'DISPID_SGRsCommit', 'DISPID_SGRSTPropertyId', 'SPEI_MIN_TTS',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRRTLength', 'SITooLoud',
    'SRAONone', 'DISPID_SVEAudioLevel', 'SAFTCCITT_ALaw_8kHzStereo',
    ...
    'SDKLCurrentUser', 'eLEXTYPE_APP',
    'DISPID_SPPBRestorePhraseFromMemory', 'eLEXTYPE_PRIVATE12',
    'SpeechDataKeyLocation', 'ISpeechPhraseRules',
    'DISPID_SGRs_NewEnum', 'DISPID_SPRFirstElement',
    'DISPID_SRGetRecognizers', 'IInternetSecurityManager',
    'DISPID_SVESentenceBoundary', 'SAFT24kHz16BitMono', 'SRAExport',
    'SPFM_OPEN_READONLY', 'ISpeechPhraseReplacements',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPRulesItem',
    'SAFT22kHz16BitMono', 'eLEXTYPE_PRIVATE11',
    'SAFTADPCM_44kHzStereo', 'SpeechRuleState', 'SVP_19',
    'SRERecoOtherContext', 'SPWORD', 'Speech_Max_Pron_Length',
    'SPVOICESTATUS', 'DISPID_SOTGetAttribute', 'DISPIDSPTSI',
    'SVSFNLPMask', 'DISPID_SWFEBitsPerSample', 'SAFT12kHz16BitStereo',
    'SPEI_TTS_PRIVATE', '_ISpeechVoiceEvents',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPPValue',
    'DISPID_SRGDictationLoad', 'DISPID_SASCurrentDevicePosition',
    'SPBO_TIME_UNITS', 'SpeechGrammarWordType',
    'DISPID_SGRSTNextState', 'SPEI_SOUND_END', 'DISPID_SPIGrammarId',
    'SPWF_INPUT', 'DISPID_SVEWord', 'SPEI_TTS_BOOKMARK',
    'DISPID_SVSVisemeId', 'SpeechFormatType',
    'DISPID_SpeechObjectTokens', 'ISpDataKey', 'DISPID_SRCEBookmark',
    'DISPID_SBSRead', 'SPSHT_Unknown', 'DISPID_SRGCommit',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVP_21', 'DISPID_SVGetVoices',
    'STSF_AppData', 'SPWORDTYPE', 'eLEXTYPE_VENDORLEXICON',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SpeechLexiconWords',
    'DISPID_SGRAddState', 'SPVPRI_ALERT',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechAudioFormatType',
    'SP_VISEME_20', 'SAFT24kHz16BitStereo',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SWFEAvgBytesPerSec',
    'ISpRecoGrammar', 'ISpNotifySink', 'SpeechPropertyAdaptationOn',
    'ISpeechPhraseProperties', 'SPINTERFERENCE_TOOFAST',
    'SPCS_DISABLED', 'SpeechPropertyResponseSpeed',
    'SpCompressedLexicon', 'DISPID_SPIGetText', 'eLEXTYPE_PRIVATE3',
    'eLEXTYPE_PRIVATE16', 'SDTLexicalForm', 'SPFM_OPEN_READWRITE',
    'SpeechAudioVolume', 'SPPHRASEPROPERTY', 'SPFM_CREATE',
    'SAFTADPCM_11kHzStereo', '_SPAUDIOSTATE', 'SAFT44kHz8BitMono',
    'SAFTNonStandardFormat', 'DISPID_SPACommit',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPAsItem',
    'ISpeechPhraseElement', 'ISpeechMemoryStream',
    'DISPID_SVSInputWordPosition', 'SFTSREngine',
    'SpeechTokenContext', 'DISPID_SDKSetBinaryValue',
    'SPEI_RESERVED5', 'SPSHT_EMAIL', 'SPSLMA', 'SpPhoneConverter',
    'SVPNormal', 'ISpRecoGrammar2', 'SPEI_MAX_TTS',
    'DISPID_SDKEnumValues', 'DISPID_SLGenerationId',
    'SREPropertyNumChange', 'SpeechCategoryVoices',
    'DISPID_SOTCGetDataKey', 'DISPID_SVGetAudioInputs',
    'SPBINARYGRAMMAR', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SABufferInfo', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechPhraseReplacement', 'SRERequestUI', 'SSTTDictation',
    'SpeechWordType', 'DISPID_SRGDictationSetState',
    'DISPID_SABIEventBias', 'SDA_Two_Trailing_Spaces', 'SP_VISEME_3',
    'DISPID_SVEBookmark', 'DISPID_SRGCmdSetRuleState',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SDKDeleteKey',
    'SAFT8kHz16BitMono', 'SpInProcRecoContext', 'SWTAdded',
    'DISPID_SPAs_NewEnum', 'SPSHT_NotOverriden',
    'SpSharedRecoContext', 'SpeechPartOfSpeech', 'DISPID_SOTRemove',
    'ISpeechXMLRecoResult', 'DISPID_SPCIdToPhone',
    'SpeechPropertyHighConfidenceThreshold', 'ISpeechAudioStatus',
    'SPEI_ADAPTATION', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTADPCM_8kHzStereo', 'DISPID_SAVolume', 'ISpPhoneConverter',
    'SECFIgnoreCase', 'SpeechCategoryAudioOut', 'SVSFIsNotXML',
    'ISpeechAudioFormat', 'DISPID_SpeechAudioStatus',
    'DISPID_SRCEFalseRecognition', 'DISPID_SpeechBaseStream',
    'SpeechEmulationCompareFlags', 'DISPID_SVSpeak',
    'SPSEMANTICERRORINFO', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRRecognizer', 'SpeechCategoryPhoneConverters',
    'DISPID_SDKGetBinaryValue', 'DISPID_SDKOpenKey', 'SRATopLevel',
    '__MIDL_IWinTypes_0009', 'SREAudioLevel',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPEAudioTimeOffset',
    'SpeechPropertyNormalConfidenceThreshold', 'SREAllEvents',
    'SPFM_CREATE_ALWAYS', 'SPSInterjection', 'SpShortcut',
    'SPRST_ACTIVE', 'SPSHORTCUTTYPE', 'SpeechTokenKeyAttributes',
    'SpeechRecoContextState', 'ISpObjectTokenCategory',
    'DISPID_SVAudioOutput', 'DISPID_SDKEnumKeys', 'SVSFIsXML',
    'ISpeechRecoResult', 'DISPID_SLPsItem', 'DISPID_SGRsAdd',
    'DISPID_SFSOpen', 'eWORDTYPE_DELETED', 'SGRSTTTextBuffer',
    'DISPIDSPTSI_SelectionOffset', 'SPGS_DISABLED',
    'DISPID_SPRuleEngineConfidence', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SpeechPhraseProperty', 'SpUnCompressedLexicon',
    '_ISpeechRecoContextEvents', 'DISPID_SRCEEnginePrivate',
    'SpStream', 'SPEI_PROPERTY_STRING_CHANGE', 'SPVPRIORITY',
    'DISPID_SLAddPronunciation', 'SpeechInterference',
    'SRSActiveAlways', 'SRCS_Enabled', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SVEStreamStart', 'DISPID_SPERetainedSizeBytes',
    'SpeechSpecialTransitionType', 'SP_VISEME_18',
    'DISPID_SpeechLexicon', 'SVSFVoiceMask', 'SpeechStreamFileMode',
    'SSSPTRelativeToEnd', 'SGSExclusive', 'SVP_17',
    ...
    'eLEXTYPE_PRIVATE10', 'DISPID_SRGCmdLoadFromFile', 'SPRECOSTATE',
    'SPCATEGORYTYPE', 'SITooQuiet', 'SVP_2', 'SRSEIsSpeaking',
    'SLTUser', 'DISPID_SPPConfidence', 'DISPID_SMSAMMHandle',
    'SAFTCCITT_ALaw_22kHzMono', 'SAFT16kHz16BitMono',
    'DISPID_SRCVoicePurgeEvent', 'SGSDisabled', 'SPDATAKEYLOCATION',
    'DISPID_SDKSetStringValue', 'DISPID_SpeechPhraseElement',
    'DISPID_SRState', 'DISPID_SOTCEnumerateTokens', 'SVSFParseSapi',
    'DISPID_SRGDictationUnload', 'SECFDefault', 'SPWT_DISPLAY',
    'DISPID_SLPType', 'SpeechWordPronounceable', 'SRADynamic',
    'SpMMAudioEnum', 'DISPID_SVSInputWordLength',
    'DISPID_SPEDisplayAttributes', 'ISpObjectWithToken',
    'SpeechEngineProperties', 'SVF_None', 'SP_VISEME_10',
    'SPCT_COMMAND', 'SpeechDisplayAttributes', 'SpeechVisemeType',
    'SAFTCCITT_ALaw_8kHzMono', 'SpeechTokenKeyUI', 'SGRSTTWord',
    'SPPHRASERULE', 'SpeechRunState', 'DISPID_SRRAudio',
    'SpeechCategoryAudioIn', 'SpSharedRecognizer',
    'SECFNoSpecialChars', 'SPTEXTSELECTIONINFO', 'SPFILEMODE',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVEViseme', 'SP_VISEME_0',
    'SPSMF_UPS', 'SpMemoryStream', 'SPRS_ACTIVE_USER_DELIMITED',
    'SGDisplay', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPEs_NewEnum', 'DISPID_SRRTOffsetFromStart',
    'SREFalseRecognition', 'DISPID_SVPause',
    'DISPID_SVSInputSentenceLength', 'SAFTGSM610_44kHzMono',
    'SVSFPersistXML', 'SECFIgnoreKanaType',
    ...
    'DISPID_SOTCId', 'DISPID_SRRSaveToMemory', 'SRADefaultToActive',
    'ISpStreamFormat', 'DISPID_SPISaveToMemory', 'SPPS_RESERVED3',
    'SPCT_SLEEP', 'DISPID_SOTId', 'Speech_Default_Weight',
    'DISPID_SGRSTPropertyValue', 'SSSPTRelativeToStart', 'SASRun',
    'SpeechVoiceSpeakFlags', 'SpeechVisemeFeature',
    'SPEI_WORD_BOUNDARY', 'SVEStartInputStream', 'DISPID_SMSGetData',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRRGetXMLErrorInfo', 'SVPAlert',
    'SPEI_RESERVED1', 'DISPID_SRCEAudioLevel', 'SAFT16kHz8BitStereo',
    'SAFT48kHz8BitStereo', 'SVP_10', 'SPSModifier', 'SPEI_UNDEFINED',
    'SSFMOpenReadWrite', 'DISPID_SLWLangId', 'DISPID_SRRGetXMLResult',
    'DISPID_SRCEPhraseStart', 'SSFMCreate', 'SpStreamFormatConverter',
    'DISPID_SPEAudioSizeTime', 'SP_VISEME_16', 'SREHypothesis',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT12kHz8BitMono', 'SAFTCCITT_uLaw_8kHzMono', 'ISpEventSink',
    'DISPID_SVEStreamEnd', 'DISPID_SREmulateRecognition',
    'SPCT_SUB_DICTATION', 'DISPID_SAStatus', 'ISpeechRecoGrammar',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTADPCM_22kHzStereo',
    'SAFT48kHz8BitMono', 'SREBookmark', 'DISPID_SVEventInterests',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SDKGetlongValue',
    'SDKLDefaultLocation', 'DISPID_SPIGetDisplayAttributes',
    'SPLOADOPTIONS', 'eLEXTYPE_PRIVATE14', 'DISPID_SpeechRecognizer',
    'ISpEventSource', 'SPEVENT', 'SAFTADPCM_22kHzMono',
    'DISPID_SPPId', 'SRERecognition', 'STCAll', 'SP_VISEME_14',
    'DISPID_SBSFormat', 'SAFT8kHz8BitStereo', 'DISPID_SPPParent',
    'DISPID_SpeechMMSysAudio', 'eLEXTYPE_PRIVATE8', 'SGRSTTRule',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRCEInterference', 'SPAS_RUN',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPAR_Unknown',
    'DISPID_SOTCreateInstance', 'SpPhraseInfoBuilder', 'SPSFunction',
    'SPEI_SR_AUDIO_LEVEL', 'SASStop', 'eLEXTYPE_PRIVATE2',
    'SpMMAudioIn', 'SPPS_Modifier', 'SVSFNLPSpeakPunc', 'SPAR_Low',
    ...
    'SPSSuppressWord', 'STSF_CommonAppData', 'DISPID_SBSWrite',
    'eLEXTYPE_PRIVATE9', 'ISpGrammarBuilder',
    'DISPID_SOTGetStorageFileName', 'SRTAutopause', 'DISPID_SPRuleId',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPIElements',
    'DISPID_SVGetAudioOutputs', 'ISpSerializeState',
    'DISPID_SRCreateRecoContext',
    'SpeechPropertyComplexResponseSpeed', 'SDKLCurrentConfig',
    'DISPID_SGRsDynamic', 'DISPID_SRCEEndStream', 'SpeechLexiconType',
    'SWPKnownWordPronounceable', 'SpeechCategoryRecognizers',
    'DISPID_SVAlertBoundary', 'eLEXTYPE_RESERVED9', 'ISpeechAudio',
    'SPPS_Interjection', 'DISPID_SRGetFormat',
    'SpeechAudioFormatGUIDText', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SDKCreateKey', 'ISpeechPhraseInfoBuilder',
    'SRAORetainAudio', 'SpNotifyTranslator', 'SPCS_ENABLED',
    'SpeechPropertyResourceUsage', 'SPPS_RESERVED2', 'SPEI_RESERVED3',
    'SPSMF_SAPI_PROPERTIES', 'ISpeechPhraseInfo', 'SAFT32kHz8BitMono',
    'SLTApp', 'DISPID_SRProfile', 'ISequentialStream',
    'DISPID_SpeechPhraseProperties', 'SPEI_RECOGNITION',
    'DISPID_SPEsItem', 'SPPS_Noun', 'DISPID_SPPFirstElement',
    'SPEI_SR_PRIVATE', 'ISpeechPhraseAlternates', 'ISpPhraseAlt',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SWFEBlockAlign', 'DISPID_SRAudioInput',
    'ISpeechRecoResult2', 'eLEXTYPE_RESERVED7',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SGRSTText', 'DISPID_SPPsItem',
    'ISpeechRecognizerStatus', 'SP_VISEME_19', 'DISPID_SRCESoundEnd',
    'SVP_3', 'WAVEFORMATEX', 'SPPHRASEELEMENT', 'SPSHT_OTHER',
    'DISPID_SLGetPronunciations', 'DISPID_SGRSTPropertyName',
    'SINoSignal', 'SPEI_PHRASE_START', 'SPGS_EXCLUSIVE',
    'DISPID_SRRSpeakAudio', 'DISPID_SRCCmdMaxAlternates',
    'eLEXTYPE_PRIVATE5', 'DISPID_SLPs_NewEnum',
    'DISPIDSPTSI_SelectionLength', 'ISpObjectToken',
    'SPGRAMMARWORDTYPE', 'SPAS_CLOSED', 'ISpeechGrammarRule',
    'eLEXTYPE_RESERVED8', 'DISPID_SRCERecognition',
    'tagSPPROPERTYINFO', 'SLOStatic', 'SRESoundEnd',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPRules_NewEnum',
    'SPXMLRESULTOPTIONS', 'SDA_No_Trailing_Space', 'DISPID_SVVoice',
    'DISPID_SVSLastBookmark', 'SVF_Emphasis', 'DISPID_SLWWord',
    'ISpeechGrammarRuleState', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SSTTWildcard', 'SPEI_MAX_SR', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPRuleFirstElement',
    'IEnumString', 'SP_VISEME_2', 'DISPID_SRGSetTextSelection',
    'SAFT32kHz16BitStereo', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPDKL_DefaultLocation', 'DISPID_SAFGetWaveFormatEx',
    'SpeechDiscardType', 'DISPID_SOTDataKey', 'SVP_8',
    'SRSInactiveWithPurge', 'SVEPrivate', 'DISPID_SLPSymbolic',
    'DISPID_SVEEnginePrivate', 'DISPID_SpeechRecoResult2',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SDKLLocalMachine',
    'DISPID_SLRemovePronunciation', 'DISPID_SPIEnginePrivateData',
    'DISPID_SGRsCount', 'SAFT48kHz16BitMono', 'ISpStream',
    'SPEVENTSOURCEINFO', 'SPEI_TTS_AUDIO_LEVEL', 'SVP_11',
    'DISPID_SGRSTWeight', 'DISPID_SGRSTransitions', 'SDTAll',
    'SpCustomStream', 'SpeechRuleAttributes',
    'SpeechRegistryUserRoot', 'SWPUnknownWordPronounceable',
    'SGDSActiveWithAutoPause', 'DISPID_SRGCmdSetRuleIdState',
    'ISpeechLexiconPronunciation', 'SPSVerb', 'SVP_15',
    'SpeechCategoryRecoProfiles', 'DISPID_SOTCSetId',
    'SPSERIALIZEDRESULT', 'DISPID_SRRSetTextFeedback',
    'SREPhraseStart', 'SPRECOGNIZERSTATUS', 'SPEI_START_INPUT_STREAM',
    'SPPS_Verb', 'SVP_18', 'SPPARTOFSPEECH', 'ISpeechPhoneConverter',
    'SpeechEngineConfidence', 'SVEVoiceChange', 'SAFT24kHz8BitMono',
    'SVSFlagsAsync', 'SDTAlternates', 'DISPID_SPIReplacements',
    'SREInterference', 'SpLexicon', 'SAFT24kHz8BitStereo',
    'DISPID_SRGId', 'DISPID_SRGCmdLoadFromResource',
    'ISpRecoContext2', 'DISPID_SRCAudioInInterferenceStatus',
    'SREStreamEnd', 'SP_VISEME_9', 'SPRULE', 'DISPID_SVPriority',
    'STCInprocServer', 'SPEI_END_SR_STREAM',
    'SpeechGrammarTagDictation', 'DISPID_SRCPause',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_RESERVED6',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRCRetainedAudio',
    'SPWT_LEXICAL', 'SPEI_SOUND_START',
    'DISPID_SRSCurrentStreamNumber', 'SREAdaptation',
    'SPEI_INTERFERENCE', 'UINT_PTR', 'ISpeechCustomStream',
    'SREStreamStart', 'DISPID_SRCRecognizer', 'SVP_7',
    'DISPID_SPAPhraseInfo', 'DISPID_SVSInputSentencePosition',
    'ISpeechTextSelectionInformation', 'ISpeechMMSysAudio',
    'SRSEDone', 'eLEXTYPE_RESERVED10', 'SVP_13',
    'DISPID_SPCPhoneToId', 'SpeechBookmarkOptions',
    'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_PRIVATE13', 'ISpeechVoice',
    'SPAS_STOP', 'DISPID_SVResume', 'LONG_PTR', 'DISPID_SVRate',
    'DISPID_SOTGetDescription', 'SSSPTRelativeToCurrentPosition',
    'SSFMCreateForWrite', 'DISPID_SPIProperties', 'SRTStandard',
    ...
    'SPEI_VISEME', 'DISPIDSPRG', 'ISpPhrase', 'DISPID_SOTDisplayUI',
    'SAFTText', 'DISPID_SRCEventInterests', 'DISPID_SVEPhoneme',
    'DISPID_SGRAttributes', 'SpeechLoadOption', 'ISpAudio',
    'STCRemoteServer', 'IStream', 'SPVPRI_NORMAL',
    ...
    'SPSTREAMFORMATTYPE', 'SRCS_Disabled', 'DISPIDSPTSI_ActiveLength',
    'SPEI_END_INPUT_STREAM', 'SAFTCCITT_ALaw_11kHzStereo', 'SINone',
    'DISPID_SpeechVoice', 'SAFTGSM610_11kHzMono', 'SPPS_RESERVED1',
    'eLEXTYPE_PRIVATE19', 'eLEXTYPE_RESERVED4', 'SVEBookmark',
    'SVP_5', 'SPRS_INACTIVE', 'SREPrivate',
    'DISPID_SDKGetStringValue', 'DISPID_SBSSeek',
    'IEnumSpObjectTokens', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPAsCount', 'SP_VISEME_6', 'DISPID_SFSClose', 'SPSNoun',
    'SPPS_Unknown', 'SPPS_SuppressWord', 'SVP_14',
    'DISPID_SPPNumberOfElements', 'ISpRecognizer3',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFT16kHz16BitStereo',
    'SAFTADPCM_8kHzMono', 'DISPID_SPEEngineConfidence', 'SPAO_NONE',
    'SPAS_PAUSE', 'ISpeechVoiceStatus', 'SpeechAddRemoveWord',
    'SGLexical', 'DISPID_SPPName', 'SPPS_Function',
    'ISpeechLexiconWords', 'SVPOver', 'Speech_StreamPos_RealTime',
    'DISPID_SRCESoundStart', 'DISPID_SpeechGrammarRule', 'SRSActive',
    'SECFIgnoreWidth', 'DISPID_SPRuleParent', 'DISPID_SRCBookmark',
    'DISPID_SPCLangId', 'SP_VISEME_15', 'SAFT22kHz16BitStereo',
    'SPSUnknown', 'SpeechVoicePriority', 'ISpeechLexiconWord',
    'ISpeechDataKey', 'DISPID_SPRsItem',
    'DISPID_SpeechRecoContextEvents', 'SPAR_High', 'SDTPronunciation',
    'DISPID_SVSLastResult', 'SpeechMicTraining', 'DISPID_SPPChildren',
    'SPSEMANTICFORMAT', 'SGDSInactive', 'ISpeechRecoContext',
    'ISpeechGrammarRules', 'ISpXMLRecoResult', 'DISPID_SPRText',
    '_RemotableHandle', 'ISpeechFileStream', 'ISpRecoResult',
    'SASClosed', 'Speech_StreamPos_Asap', 'SFTInput',
    'eWORDTYPE_ADDED', 'SVP_12', 'DISPID_SPRsCount',
    'DISPID_SWFEExtraData', 'DISPID_SRCEAdaptation', 'SPFM_NUM_MODES',
    'SPAUDIOOPTIONS', 'eLEXTYPE_PRIVATE6', 'SPPROPERTYINFO',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SDTProperty',
    'DISPID_SASCurrentSeekPosition', 'SPRST_NUM_STATES',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SWFESamplesPerSec',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SPARecoResult',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SOTIsUISupported',
    'DISPID_SCSBaseStream', 'SpFileStream',
    ...
    'DISPID_SLWPronunciations', 'DISPID_SRRRecoContext',
    'SpObjectTokenCategory', 'SVSFParseSsml',
    'SGLexicalNoSpecialChars', 'SPBO_NONE', 'SVSFIsFilename',
    'SSTTTextBuffer', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SITooFast', 'SpeechAudioProperties', 'SINoise',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SOTSetId',
    'DISPID_SVGetProfiles', 'SPINTERFERENCE', 'SREStateChange',
    'SPRS_ACTIVE', 'SASPause', 'DISPID_SABIBufferSize',
    'SVSFPurgeBeforeSpeak', 'DISPID_SGRSTRule',
    'SpeechRecognizerState', 'SPWORDLIST', 'ISpeechPhraseElements',
    'DISPID_SpeechAudioFormat', 'SAFT22kHz8BitStereo',
    'ISpeechGrammarRuleStateTransitions', 'ISpLexicon',
    'DISPID_SRCRequestedUIType', 'DISPID_SGRSRule', 'SVP_0',
    'SPRULESTATE', 'DISPID_SVVolume',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPRuleChildren', 'DISPID_SGRSTsItem', 'SP_VISEME_7',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SLPPartOfSpeech',
    'SPEVENTENUM', 'SPINTERFERENCE_NOISE', 'tagSTATSTG',
    'DISPID_SRCEHypothesis', 'SPDKL_CurrentUser',
    'DISPID_SASFreeBufferSpace', 'SLODynamic', 'SVEViseme',
    'SRSInactive', 'DISPID_SRSetPropertyString', 'SPPS_RESERVED4',
    'DISPID_SMSSetData', 'DISPID_SLPPhoneIds', 'SGRSTTEpsilon',
    'SRAImport', 'DISPID_SRGSetWordSequenceData',
    'SPINTERFERENCE_TOOSLOW', 'SPSERIALIZEDPHRASE',
    'DISPID_SGRAddResource', 'SVEWordBoundary', 'DISPID_SVDisplayUI',
    'SPEI_RESERVED6', 'DISPID_SVSLastBookmarkId',
    'DISPID_SpeechXMLRecoResult', 'SPVISEMES',
    'DISPID_SRCEPropertyNumberChange', 'SITooSlow',
    'SpeechTokenIdUserLexicon', 'ISpeechObjectTokenCategory',
    'SDTRule', 'DISPID_SRAudioInputStream', 'DISPID_SOTCategory',
    'SVEAllEvents', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SAFType', 'SPEI_SR_BOOKMARK', 'DISPID_SGRsFindRule',
    'DISPID_SpeechPhraseRules', 'SSFMOpenForRead'
]

_check_version('1.2.0', 1701670980.888231)
