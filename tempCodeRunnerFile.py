...
def start_recognition():
    ...
    button_register = tk.Button(root, text="Register", command=on_register_button_click, bg="#FF5733", fg="white", font=("Arial", 14))
    button_register.pack(side=tk.LEFT, padx=10, pady=10)  # Add some padding and position it to the left
